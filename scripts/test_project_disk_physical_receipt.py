...
class ProjectDiskPhysicalReceiptTests(unittest.TestCase):
    ...
    def test_first_capture_records_opaque_entries_without_role_inference(self) -> None:
    ...
    def test_duplicate_keys_and_unknown_receipt_fields_are_refused(self) -> None:
