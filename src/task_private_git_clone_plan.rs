...
mod tests {
    ...
    use crate::trusted_overlay_task_view::{
        ...
        OverlayTaskViewGeneration, OverlayTaskViewId, OverlayTaskViewLease, OverlayTaskViewObservation,
    ...
    impl LogicalFixture {
        ...
        fn observation(&self) -> crate::immutable_git_object_pool_observation::ImmutableGitObjectPoolObservation {
            observe_immutable_git_object_pool_generation_for_test(
    ...
    fn exact_leases_seal_explicit_reference_no_local_clone() {
        ...
        assert!(argv.iter().any(|value| value == "/srv/smolrunner/pools/generation"));
        assert!(argv.iter().any(|value| value == "/srv/smolrunner/tasks/task-a.git"));
        assert!(argv.iter().any(|value| value == "/srv/smolrunner/views/task-a"));
        assert!(
            argv.iter()
