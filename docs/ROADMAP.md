...
- [ ] Pin the official runner archive/version by exact digest and derive the prepared-template identity from the exact guest image, runner archive, provisioning inputs, and isolation policy.
