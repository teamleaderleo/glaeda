...
zero-capacity poll becomes one short-lived durable clone-admission observation, and the private
coordinator consumes a fresh observation at each of the authorization and clone-start barriers.
