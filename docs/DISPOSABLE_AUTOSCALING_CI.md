...
cancellation and capacity vetoes remain clear at a later mutation barrier; production clone
composition therefore remains disabled until a live observation can also durably retain any newly
arrived Scale Set message before returning control.
