...
CLI plan report around that service. The exact apply/remove engine consumes one explicit approved
plan and revalidates installation inputs while permitting exact cleanup after those inputs are
lost or rotated. CLI apply exposure, real macOS stop-signal wiring, installed
bridge/executable/enrollment verification, automatic quiescence of an unbound
